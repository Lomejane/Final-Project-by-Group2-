...
<div className="contact" style="min-height: 100vh">
    <div class="row">
        <div class="col-4">
    ...
    {{-- <div className="rightSide" style="  height: 100%;
    flex: 30%;
    display: flex;
    ...
    justify-content: center;">
      ...
      <form method="POST" id="contact-form" style="  display: flex;
      flex-direction: column;
      width: auto;
      height: auto;
      padding: 30px;">
    ...
    <div className="googlemap" style="  height: 100%;
    flex: 40%;
    display: flex;
    flex-direction: column;
    justify-content: center;">       
