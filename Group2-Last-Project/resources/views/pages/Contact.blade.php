    ...
    <section id="contact">
        ...
        <div class="row d-flex flex-row flex-wrap">
            <div class="col-md-4 first">
                {{-- <img src="../assets/for_buy.jpg" alt=" building image"> --}}
            </div>
            ...
            <div class="col-md-4">
                <div class="container">
                    ...
                    <form action="" method="">
                        <label>Name</label>
                        <input type="text" class="form-control shadow" style="border:#368D96 solid 1px" name="name" id="">
                        <label>Email</label>
                        <input type="text" class="form-control shadow" style="border:#368D96 solid 1px"name="name" id="">
                        <label>Phone</label>
                        <input type="text" class="form-control shadow" style="border:#368D96 solid 1px" name="name" id="">
                        <label>Nationality</label>
                        <select name="nationality" class="form-control shadow selectpicker" style="border:#368D96 solid 1px">
                    ...
                    <label>Message</label>
                    <textarea class="form-control shadow" style="border:#368D96 solid 1px" name="" id="" cols="30" rows="10" placeholder="Type Message">
                    </textarea>
                    <br>
